...
(Modified to save plots to visualization folder)
...
def create_naive_comparison_plot(naive_results):
    ...
    plt.tight_layout()
    save_figure(plt.gcf(), '01_naive_comparison.png')
    plt.close()
...
def create_confounding_visualizations(sim_data):
    ...
    plt.tight_layout()
    save_figure(plt.gcf(), '02_confounding_visualizations.png')
    plt.close()
...
def compare_naive_to_true(sim_data, ground_truth, naive_results):
    ...
    plt.tight_layout()
    save_figure(plt.gcf(), '03_naive_vs_true_comparison.png')
    plt.close()
